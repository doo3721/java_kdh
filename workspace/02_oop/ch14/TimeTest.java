...
public class TimeTest {
    public static void main(String[] args) {
        ...
        // 부트캠프 시작일은 2026-05-14일 입니다
        // 수료일은 2026-11-16일 입니다.
        // 오늘은 부트캠프 시작일로부터 몇일이 지났는지 출력
        // 앞으로 몇일이 지나면 수료하는지 출력
        // 총 수업 기간은 몇일인지 출력
        ...
        System.out.println("경과일: " + (today.toEpochDay() - startDate.toEpochDay()) + "일");
        System.out.println("남은 수업일: " + (finishDate.toEpochDay() - today.toEpochDay()) + "일");
        System.out.println("총 수업일: " + (finishDate.toEpochDay() - startDate.toEpochDay()) + "일");
    }
}
